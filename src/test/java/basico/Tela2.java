...
public class Tela2 {
    ...
    public String preencherTela2(WebDriver driver, Variaveis dados) throws InterruptedException, AWTException, FindFailed, UnsupportedFlavorException, IOException {
        ...
        if (VerificarElemento.verificar(driver, "auto_order_flow_pricing_requirements_vehicle_attributes_license_plate_or_vin", "ID", 1)) {
            ...
            if (VerificarElemento.verificar(driver,"//*[@id=\"container\"]/div[10]/div/a","XPATH",5)){
