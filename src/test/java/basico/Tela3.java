...
public class Tela3 {
    ...
    public void preencherTela3(WebDriver driver, Variaveis dados) throws InterruptedException, IOException, UnsupportedFlavorException, FindFailed, AWTException {
      ...
      /* if (driver.findElements(By.xpath("//*[contains(text(), 'Que tal pagar o Seguro Auto por Km rodado?')]")).size() > 0) {
            driver.findElement(By.xpath("//*[contains(text(), 'Cancelar')]")).click();
        }*/
        ...
        if (VerificarElemento.verificar(driver, "//*[contains(@data-track-name, 'Vale para perda total')]", "XPATH", 30)) {
            ...
            if (pacote.contains("ESSENCIAL")) {
                ...
                //roubo e furto só, nao ontratrar vale perda total, removendo
                WebElement meuchkcoli1 = driver.findElement(By.xpath("//*[contains(@data-track-name, 'Vale para perda total')]"));

                JavascriptExecutor jsColi1 = (JavascriptExecutor) driver;
                jsColi1.executeScript("arguments[0].click();", meuchkcoli1);

                //TIRANDO DANOS MATERIAIS
